    ...
    switch (linkid.split('.')[1]) {
        ...
        case 'c':
            inner = (<div className="doubleShell">
                <textarea type="text" value={left} onChange={e=>editItem('left', e.target.value, parentid, linkid)} />
                <textarea type="text" value={right} onChange={e=>editItem('right', e.target.value, parentid, linkid)} />
            </div>)
            break;
        case 'i':
            inner = (<div className="doubleShell">
